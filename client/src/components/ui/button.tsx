...
// Direction D: buttons use moderate 14px radius (rounded-xl), not pill. Editorial register over
// "fun" — see CLAUDE.md anti-pattern "Don't translate a brand colour as a flood-fill".
