...
export const post: BlogPostFull = {
  ...
  metaDescription: "Learn to read your dog's body language during walks. Understand tail positions, ear signals, stress indicators, and happy cues to make every walk safer and more enjoyable.",
  keywords: [
    "dog body language",
    "dog behavior walking",
    "reading dog signals",
    "dog tail wagging meaning",
    "dog walk behavior"
  ],
  tags: ["behavior", "body language", "walking", "training"],
  featured: false,
  status: "published",
  relatedSlugs: ["socializing-your-dog-through-walks", "the-science-of-dog-walking"],
  content: `
