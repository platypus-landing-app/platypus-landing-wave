...
export const post: BlogPostFull = {
  slug: "how-gps-tracking-keeps-your-dog-safe",
  title: "How GPS Tracking Keeps Your Dog Safe During Walks",
  ...
  metaDescription: "Learn how GPS tracking technology keeps your dog safe during walks. Discover the benefits of real-time route monitoring, live updates, and how modern pet care uses technology for safety.",
  keywords: [
    "GPS dog tracking",
    "dog walk tracking",
    "live tracking dog walker",
    "pet safety technology",
    "GPS pet care"
  ],
  tags: ["technology", "GPS", "safety", "dog walking"],
  featured: false,
  status: "published",
  relatedSlugs: ["why-every-pet-parent-should-consider-dog-walking-service", "how-to-choose-right-dog-walker-mumbai"],
  content: `
