...
export const post: BlogPostFull = {
  slug: "indoor-vs-outdoor-exercise-for-dogs",
  title: "Indoor vs Outdoor Exercise for Dogs: What Does Your Dog Need?",
  ...
  metaDescription: "Compare indoor and outdoor exercise for dogs. Learn why outdoor walks are irreplaceable for sensory stimulation and how to create a balanced fitness routine for your pet.",
  keywords: [
    "indoor dog exercise",
    "outdoor dog exercise",
    "dog exercise comparison",
    "apartment dog exercise",
    "dog fitness"
  ],
  tags: ["exercise", "health", "indoor", "outdoor"],
  featured: false,
  status: "published",
  relatedSlugs: ["the-science-of-dog-walking", "how-much-exercise-does-my-dog-need"],
  content: `
Living in an apartment does not mean your dog has to miss out on exercise. But relying only on indoor play has its limits. Understanding the strengths of both indoor and outdoor exercise helps you build a routine that meets your dog's physical and mental needs.
...
While indoor play covers the basics, outdoor time delivers something no living room can replicate: sensory stimulation. Outside, there are smells, sounds, textures, and sights that activate your dog's brain in ways indoor environments cannot. Every fire hydrant, patch of grass, and passing breeze carries information that engages your dog's most powerful sense, their nose. This sensory engagement is critical for cognitive health, reducing boredom, and preventing anxiety-driven behaviors like excessive barking or destructive chewing.
