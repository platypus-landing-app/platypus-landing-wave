...
export const post: BlogPostFull = {
  slug: "summer-dog-walking-safety-mumbai",
  title: "Summer Dog Walking Safety: How to Protect Your Dog in Mumbai's Heat",
  excerpt: "Mumbai summers can be brutal for dogs. Pavement burns, heatstroke, and dehydration are real risks. Here's a complete guide to keeping your dog safe during hot weather walks.",
  author: "Sagar Sutaria",
  date: "2025-09-15",
  updatedDate: "2025-02-16",
  readTime: "7 min read",
  category: "Safety Tips",
  image: "/blog/summer-dog-walking-safety-mumbai.jpg",
  metaDescription: "Protect your dog from Mumbai's summer heat with these essential safety tips. Learn about pavement burns, heatstroke signs, hydration, and the best times for summer dog walks.",
  keywords: [
    "summer dog walking safety",
    "dog walking in heat Mumbai",
    "dog heatstroke prevention",
    "hot pavement dogs",
    "summer pet care tips",
    "dog walking safety tips Mumbai"
  ],
  ...
  howToSteps: [
    ...
    { name: "Carry water and a portable bowl", text: "Bring fresh water and a collapsible bowl on every walk. Offer water every 10-15 minutes during summer walks." },
    { name: "Watch for heatstroke signs", text: "Monitor for excessive panting, drooling, lethargy, bright red tongue, vomiting, or stumbling. Stop immediately and cool the dog down if you see any of these signs." },
    { name: "Choose shaded routes", text: "Plan walks along tree-lined streets and parks with canopy cover. Avoid open concrete areas and direct sun exposure." }
  ],
  content: `
