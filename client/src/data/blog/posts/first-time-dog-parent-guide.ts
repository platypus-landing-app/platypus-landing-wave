...
export const post: BlogPostFull = {
  slug: "first-time-dog-parent-guide",
  title: "First-Time Dog Parent? Everything You Need to Know Before Bringing a Dog Home",
  excerpt: "Getting a dog changes your life, in the best way, if you're prepared. Here's a no-nonsense guide covering everything from puppy-proofing your apartment to building a daily routine.",
  author: "Sagar Sutaria",
  date: "2025-09-25",
  updatedDate: "2025-02-16",
  readTime: "8 min read",
  category: "Pet Care Tips",
  image: "/blog/first-time-dog-parent-guide.jpg",
  metaDescription: "Complete guide for first-time dog parents in India. Learn about puppy-proofing, daily routines, vet visits, nutrition, exercise needs, and building a strong bond with your new dog.",
  keywords: [
    "first time dog parent guide",
    "new dog owner tips India",
    "bringing puppy home checklist",
    "dog parent guide Mumbai",
    "new pet owner tips",
    "puppy care guide India"
  ],
  tags: ["pet care", "guide", "puppy", "first-time"],
  featured: false,
  status: "published",
  relatedSlugs: ["preparing-your-dog-for-first-professional-walk", "how-much-exercise-does-my-dog-need"],
  content: `
...
If your schedule makes consistent daily walks difficult, a professional dog walking service fills that gap. This is exactly why we built Platypus, because we saw hundreds of well-intentioned pet parents in Mumbai who couldn't be there for every walk their dog needed.
...
**Not budgeting for ongoing costs.** The purchase price is just the beginning. Monthly food, annual vaccinations, unexpected vet visits, grooming, toys, and potentially dog walking or boarding services. Budget for ₹3,000 to ₹8,000 per month depending on your dog's size and needs.
