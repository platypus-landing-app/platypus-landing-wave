...
export const post: BlogPostFull = {
  ...
  readTime: "5 min read",
  category: "Pet Health",
  image: "/blog/morning-vs-evening-dog-walks.jpg",
  metaDescription: "Discover whether morning or evening dog walks are better for your pet. Compare health benefits, temperature factors, and breed-specific needs to find the best walking schedule.",
  keywords: [
    "morning dog walk",
    "evening dog walk",
  ...
  tags: ["dog walking", "health", "schedule", "tips"],
  featured: false,
  status: "published",
  relatedSlugs: ["the-science-of-dog-walking", "dog-walking-schedule-by-breed"],
  content: `
