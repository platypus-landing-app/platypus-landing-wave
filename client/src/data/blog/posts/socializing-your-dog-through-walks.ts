...
export const post: BlogPostFull = {
  ...
  metaDescription: "Learn how regular walks help socialize your dog by exposing them to new people, animals, and environments. Understand the signs of good socialization and how to build your dog's confidence.",
  keywords: [
    "dog socialization",
    "socializing dogs through walks",
    "dog behavior walks",
    "dog interaction",
    "puppy socialization"
  ],
  tags: ["behavior", "socialization", "walking", "training"],
  featured: false,
  status: "published",
  relatedSlugs: ["the-science-of-dog-walking", "understanding-dog-body-language-walks"],
  content: `
