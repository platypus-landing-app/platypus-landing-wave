...
export const post: BlogPostFull = {
  ...
  metaDescription: "Discover how much exercise your dog needs daily based on breed, age, and health. A vet-backed guide to creating the right fitness routine for your pet.",
  keywords: [
  ...
  tags: ["exercise", "health", "guide", "fitness"],
  featured: false,
  status: "published",
  relatedSlugs: ["labrador-exercise-walking-guide", "dog-walking-schedule-by-breed", "indoor-vs-outdoor-exercise-for-dogs"],
  content: `
