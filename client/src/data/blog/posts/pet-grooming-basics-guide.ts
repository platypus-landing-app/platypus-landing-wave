...
export const post: BlogPostFull = {
  ...
  metaDescription: "A complete guide to pet grooming basics for dog parents. Learn about bathing frequency, brushing by coat type, nail trimming, ear cleaning, and dental hygiene for your dog.",
  keywords: [
    "pet grooming basics",
    "dog grooming guide",
  ...
  tags: ["grooming", "pet care", "guide", "hygiene"],
  featured: false,
  status: "published",
  relatedSlugs: ["why-every-pet-parent-should-consider-dog-walking-service", "how-much-exercise-does-my-dog-need"],
  content: `
