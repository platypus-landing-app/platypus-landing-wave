...
export const post: BlogPostFull = {
  ...
  title: "8 Signs Your Dog Needs More Exercise (And What to Do About It)",
  excerpt: "Destructive chewing, excessive barking, weight gain, these aren't personality flaws. They're signs your dog needs more physical and mental stimulation. Here's what to watch for.",
  author: "Sagar Sutaria",
  date: "2025-09-05",
  updatedDate: "2025-02-16",
  readTime: "6 min read",
  category: "Dog Health",
  image: "/blog/signs-dog-needs-more-exercise.jpg",
  metaDescription: "Is your dog destructive, restless, or gaining weight? These are common signs of under-exercise. Learn the 8 key signs and how to fix them with the right exercise routine.",
  keywords: [
    "signs dog needs exercise",
  ...
  tags: ["dog health", "exercise", "behavior", "tips"],
  featured: false,
  status: "published",
  relatedSlugs: ["how-much-exercise-does-my-dog-need", "dog-walking-schedule-by-breed"],
  content: `
